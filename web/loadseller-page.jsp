...
<div class="container">
    ...
    <div class="container-form container-signup">
        <form action="${pageContext.request.contextPath}/SellerAccount?goal=register" class="form" id="form1" method="post">
    ...
    <div class="container-form container-signin" >
        <form action="${pageContext.request.contextPath}/SellerAccount?goal=update" class="form" id="form2" method="post">
            <h2 class="form-title">修改密码</h2>
            <input type="text" placeholder="user" class="input" name="name">
            <input type="password" placeholder="Password" class="input" name="password">
            <a href="#" class="link">直接输入账号和新密码,密码为delete则注销</a>
